...
public class RegistrationHandler {
	...
	public static void registerItems(Register<Item> event) {
		final Item[] items = {
				...
				//Gearbox
				RegistryUtil.setItemName(new Item(), "certus_quartz_gearbox", "gearboxCertusQuartz").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
				RegistryUtil.setItemName(new Item(), "fluix_gearbox", "gearboxFluix").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
				
				//Rod
				RegistryUtil.setItemName(new Item(), "certus_quartz_rod", "rodCertusQuartz").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
				RegistryUtil.setItemName(new Item(), "fluix_rod", "rodFluix").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
				
				//Gear
				RegistryUtil.setItemName(new Item(), "certus_quartz_gear", "gearCertusQuartz").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
				RegistryUtil.setItemName(new Item(), "fluix_gear", "gearFluix").setCreativeTab(MoreFactoryItems.CREATIVE_TAB),
