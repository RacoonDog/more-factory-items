...
public class OreDict {
	public static void registerOreDict() {
		...
		RegistryUtil.OreDict(ModItems.wooden_gear, "gearWood");
		RegistryUtil.OreDict(ModItems.stone_gear, "gearStone");
		RegistryUtil.OreDict(ModItems.iron_gear, "gearIron");
		RegistryUtil.OreDict(ModItems.gold_gear, "gearGold");
		...
		//Metal Gears
		RegistryUtil.OreDict(ModItems.iron_gear, "gearMetalAny");
		RegistryUtil.OreDict(ModItems.gold_gear, "gearMetalAny");
		...
		RegistryUtil.OreDict(ModItems.wooden_gear, "gearPrimitiveAny");
		RegistryUtil.OreDict(ModItems.stone_gear, "gearPrimitiveAny");
		...
		RegistryUtil.OreDict(ModItems.wooden_gear, "gearVanillaAny");
		RegistryUtil.OreDict(ModItems.stone_gear, "gearVanillaAny");
		RegistryUtil.OreDict(ModItems.iron_gear, "gearVanillaAny");
		RegistryUtil.OreDict(ModItems.gold_gear, "gearVanillaAny");
		RegistryUtil.OreDict(ModItems.emerald_gear, "gearVanillaAny");
		RegistryUtil.OreDict(ModItems.diamond_gear, "gearVanillaAny");
	}
}